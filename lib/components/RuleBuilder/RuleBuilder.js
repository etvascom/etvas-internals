...
var RuleBuilder = function RuleBuilder(_ref) {
  ...
  var createNewRule = (0, _react.useCallback)(function (specificType) {
    ...
    return Object.fromEntries([[(0, _uuid.v4)(), _extends({
      type: type
...
var valueProps = process.env.NODE_ENV !== "production" ? _propTypes["default"].shape({
...
var ruleOptionsProps = process.env.NODE_ENV !== "production" ? _propTypes["default"].objectOf(_propTypes["default"].shape({
  label: _propTypes["default"].node,
  placeholder: _propTypes["default"].string,
  allowCount: _propTypes["default"].func,
  validate: _propTypes["default"].arrayOf(validatorProps),
  ...
  value: valueProps,
  operatorValue: _propTypes["default"].objectOf(valueProps)
})).isRequired : {};
RuleBuilder.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  typeLabel: _propTypes["default"].node.isRequired,
