...
var DateRangePicker = function DateRangePicker(_ref) {
  ...
  }, mStart.format(displayFormat), " \xF7 ", mEnd.format(displayFormat)), /*#__PURE__*/_react["default"].createElement(_etvaskit.Flex, {
    mr: 2,
...
DateRangePicker.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  value: _propTypes["default"].shape({
    start: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].object, _propTypes["default"].number]).isRequired,
    end: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].object, _propTypes["default"].number]).isRequired
  }).isRequired,
